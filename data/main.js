...
function Qo(e, n, t) {
    let i = e.value;
    return (!e.comparator || !e.comparator(i, n)) && (e.value = n, e.observers && e.observers.length && Gt(() => {
...
const gl = {
    ...
    has(e, n) {
        return n === Zr || n === Be || n === Ur || n === Rt || n === Ue || n === "__proto__" ? !0 : (Xn() && cn(nr(e, Ue), n)(), n in e)
    },
    set() {
        return !0
    },
...
function Oe(e, n, t, i = !1) {
    ...
    let l = nr(e, Rt),
        c;
    if ((c = cn(l, n, o)) && c.$(() => t), Array.isArray(e) && e.length !== s) {
...
function on(e, n, t = []) {
    ...
    if (n.length > 1) {
        ...
        const l = typeof i,
            c = Array.isArray(e);
        if (Array.isArray(i)) {
            for (let u = 0; u < i.length; u++) on(e, [i[u]].concat(n), t);
            return
        } else if (c && l === "function") {
            for (let u = 0; u < e.length; u++) i(e[u], u) && on(e, [u].concat(n), t);
            return
        } else if (c && l === "object") {
            const {
                from: u = 0,
            ...
            for (let r = u; r <= d; r += p) on(e, [r].concat(n), t);
            return
        } else if (n.length > 1) {
            on(e[i], n, [i].concat(t));
            return
...
function Rc(e) {
    return function(n, t, i) {
        for (var o = function(a, f, h) {
                ...
                var a = n.getPayload();
                if (e ? a.cx : a.co) return JSON.parse(e ? Dc(a.cx) : a.co)
            }, l = function(a, f) {
                var h = a || s();
...
function Qc(e, n, t, i) {
    ...
    } else if (Os(e) && Gc(e[0], i)) return Jr(e[1], n, t, i);
    return []
}
...
function eu(e) {
    ...
    function n(u, d, p) {
        ...
        function m(b, $, H) {
            b.withJsonProcessor(Rc(f)), b.add("eid", Ec.v4()), b.addDict(h);
            var F = Xc(H);
...
function wu(e, n) {
    for (var t = window.location.hostname, i = "_sp_root_domain_test_", o = i + new Date().getTime(), s = "_test_value_" + new Date().getTime(), l = t.split("."), c = l.length - 2; c >= 0; c--) {
        ...
        if (_t(o, s, 0, "/", u, e, n), _t(o) === s) {
            ir(o, u, e, n);
            for (var d = Au(i), p = 0; p < d.length; p++) ir(d[p], u, e, n);
            return u
        }
    }
    return t
...
function xo(e, n, t) {
    var i;
    return e === "translate.googleusercontent.com" ? (t === "" && (t = n), n = (i = Pu(n, "u")) !== null && i !== void 0 ? i : "", e = ti(n)) : (e === "cc.bingj.com" || e === "webcache.googleusercontent.com") && (n = document.links[0].href, e = ti(n)), [e, n, t]
}
var Ns = 0,
    yt = 1,
    Eu = 2,
    ...
    var l = [],
        c = function(p, r, a, f, h, v) {
            ...
            var re = eu({
                ...
                xn, $t = document.title,
                qt, ca = (B = v.resetActivityTrackingOnPageView) !== null && B !== void 0 ? B : !0,
                _i, yi, ua = (N = v.cookieName) !== null && N !== void 0 ? N : "_sp_",
                Kt = (R = v.cookieDomain) !== null && R !== void 0 ? R : void 0,
                cr = "/",
            ...
            function vr(_) {
                var S = Ot(_);
                if (se == "localStorage") return _u(S);
                if (se == "cookie" || se == "cookieAndLocalStorage") return _t(S)
            }

            function Pi() {
                pt(), Si = au((Kt || qe) + (cr || "/")).slice(0, 4)
            }
            ...
            function Di(_, S, E) {
                return Le && !It ? !1 : se == "localStorage" ? qn(_, S, E) : se == "cookie" || se == "cookieAndLocalStorage" ? (_t(_, S, E, cr, Kt, Sn, Tn), document.cookie.indexOf("".concat(_, "=")) !== -1) : !1
            }

            function Mi(_) {
                var S = Ot("id"),
                    E = Ot("ses");
                _o(S), _o(E), ir(S, Kt, Sn, Tn), ir(E, Kt, Sn, Tn), _ != null && _.preserveSession || (De = tt.v4(), Me = 1), _ != null && _.preserveUser || (En = Le ? "" : tt.v4(), dt = null)
            }
            ...
            function Li() {
                if (!(Le && !It)) {
                    var _ = se != "none" && !!vr("ses"),
                        S = Jt();
                    En = Mu(S, Le), _ ? De = Dr(S) : De = tn(S), Me = Mr(S), se != "none" && (hr(), Cr(S), mr(S))
                }
            }

            function Jt() {
                if (se == "none") return Cu();
                var _ = vr("id") || void 0;
            ...
            function Ni() {
                ...
                var _ = "_sp_tab_id",
                    S = yo(_);
                return S || (yu(_, tt.v4()), S = yo(_)), S || null
            }
            ...
            function Aa() {
                ...
                return {
                    beforeTrack: function(E) {
                        ...
                        ni(ce) ? (!he && se != "none" ? De = tn(ce) : De = Dr(ce), Me = Mr(ce)) : new Date().getTime() - dr > xi * 1e3 && (Me++, De = tn(ce, {
                            memorizedVisitCount: Me
                        })), Cr(ce), Bu(ce, E), Lu(ce);
                        var Te = Br(),
                            Pt = Te.viewport,
                            Xt = Te.documentSize;
                        E.add("vp", Pt), E.add("ds", Xt), E.add("vid", S(Me)), E.add("sid", S(De)), E.add("duid", _(Vu(ce))), E.add("uid", _(dt)), pt(), E.add("refr", vt(Ke || ft)), E.add("url", vt(xn || Ce));
                        var en = So(ce, se, Le);
                        if (fa && (!Le || It) && xa(E, en), se != "none") {
                            mr(ce);
                            var yr = hr();
                            (!he || Xe) && yr && Dn && !pr && (Dn(en), pr = !1)
                        }
                        dr = new Date().getTime()
                    }
                }
            ...
            function Sa() {
                var _ = Jt();
                if (ni(_) ? (se != "none" ? De = tn(_) : De = Dr(_), Me = Mr(_)) : (Me++, De = tn(_, {
                        memorizedVisitCount: Me
                    })), Cr(_), se != "none") {
                    var S = So(_, se, Le);
                    mr(_);
            ...
            function Ta(_) {
                ...
                pt(), ki && Vi(), ki = !0, $t = document.title, qt = S;
                var Xe = wo(qt || $t);
                re.track(nu({
                    pageUrl: vt(xn || Ce),
                    pageTitle: Xe,
                        ...
                        update: function() {
                            if (typeof window < "u" && typeof window.addEventListener == "function") {
                                var Et = !1,
                                    ...
                                    Fi = function() {};
                                window.addEventListener("testPassiveEventSupport", Fi, Ln), window.removeEventListener("testPassiveEventSupport", Fi, Ln), Xt.hasSupport = Et
                            }
                        }
                    };
                    Xt.update();
            ...
            function $a(_) {
                var S = _.context,
                    ...
                    Xe = _.maxYOffset,
                    Te = document.title;
                Te !== $t && ($t = Te, qt = void 0), re.track(ru({
                    pageUrl: vt(xn || Ce),
                    pageTitle: wo(qt || $t),
                    referrer: vt(Ke || ft),
                    minXOffset: Bn(E),
...
function ju(e, n, t, i, o, s) {
    return an.hasOwnProperty(e) ? null : (an[e] = Fu(e, n, t, i, o, s), an[e])
}
...
function Xu(e, n, t) {
    if (t === void 0 && (t = {}), To) return ju(e, e, "js-".concat(iu), n, To, t)
}
...
const pf = vi(),
    ...
    wf = async () => {
        ...
        await Promise.allSettled(e), _f(!0)
    }, Ws = () => {
...
const ko = e => typeof e == "boolean" ? "".concat(e) : e === 0 ? "0" : e,
    ...
    sd = async e => {
        ...
        try {
            e === "play" && await Promise.all(ct().map(sd)), await Promise.all(ct().map(n => n.Player.dispatch(e)))
        } catch (n) {
            console.warn(n)
        }
    }, ld = async e => {
        try {
            Xf(e), !!e.archivePlaylist ? await Promise.all(ct().map(t => t.switchFeed(e.archivePlaylist))) : await Promise.all(ct().map((t, i) => {
    ...
    }, cd = z('<div role="button" class="absolute top-0 left-0 wh-full">'), ud = z('<div class="absolute bottom-0 left-0 right-0 h-[228px] px-[158px] flex space-x-68 items-center"><button></button><button></button><button></button><button></button><button>'), nn = ["w-[330px] h-[100px] flex-center bg-player-control-btn text-green rounded-sm", "shadow-player-controls-btn active:shadow-player-controls-btn-pressed", "[&>span]:w-72 [&>span]:drop-shadow-terminal"], fd = () => {
        const e = st([kf, Tf], {
            sprite: {
...
const dd = (e, n) => {
    ...
    bd = e => {
        ...
        return _e(() => {
            ...
            const u = hd(),
                d = n;
            return typeof d == "function" ? Ee(d, u) : n = u, ue(u, "src", vd), X(() => (c() ? "visible" : "hidden") != null ? u.style.setProperty("visibility", c() ? "visible" : "hidden") : u.style.removeProperty("visibility")), u
        })(), x(rs, {
            get children() {
                return [x(Bt, {
                    get when() {
    ...
    xd = e => {
        ...
        return _e(() => {
            ...
            const d = i;
            return typeof d == "function" ? Ee(d, u) : i = u, C(c, x(bd, {
                get screen() {
                    return e.screen
                }
            }), null), X(p => {
...
const Od = "/assets/answering-machine-button-glow-58ea4526.svg",
    ...
    Rd = () => (() => {
        const e = Bd(),
            n = e.firstChild,
            t = n.nextSibling;
        return e.style.setProperty("width", "150px"), e.style.setProperty("height", "85px"), e.style.setProperty("transform", "translate(403px, 924px) rotateZ(-4deg)"), ue(n, "src", Dd), ue(t, "src", Md), X(() => te(t, le(Ld, {
            hidden: !Ze.archive.hasNew()
        }))), e
    })(),
    Vd = z('<div class="absolute top-0 left-0 wh-full isolate">'),
    Nd = e => {
        const [n, t] = Y(!1), o = st(() => sn() ? [sn().srcWebm, sn().srcMp3] : []), l = st(() => [ro().srcWebm, ro().srcMp3], {
            loop: !0,
            autoplay: !0
        }), c = st([tc, nc]);
        (async () => {
        ...
        return (() => {
            ...
            }), null), C(p, x(Rd, {}), null), C(p, x(Td, {}), null), C(p, x(Cd, {}), null), C(p, x(Id, {
                onItemSelected: d
            }), null), C(p, x(Ne, {
                get when() {
    ...
    Gd = e => {
        ...
        const [o, s] = Y(rn().length - 1), [l, c] = Y([]), u = () => {
            const h = o() - 1;
        ...
        const d = () => {
            ...
            p = () => {
                o() >= rn().length - 1 || (ie.trackClickEvent("pages", "next", "logbook"), f.play("page-turn", {
                    interrupt: !0
                }), s(h => h + 1))
            },
            r = () => rn()[o()],
...
const Kd = "\n      @@@@@@@@@@@@@@@@@@@@@@@@@@@@\n    @@                         @@@\n @@                          @@@@@\n@                         @@@@@@@@\n@                         @@@@@@@@\n@  @@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @     @@@@@@@@@@    @@ @@@@@@@@\n@  @     @@      @@    @@ @@@@@@@@\n@  @     @@      @@    @@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@\n@                         @@@@@@@@\n@  @@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @     @@@@@@@@@@    @@ @@@@@@@@\n@  @     @@      @@    @@ @@@@@@@@\n@  @     @@      @@    @@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@ \n@                         @@@@@\n@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n",
    ...
    At = e => (() => {
        const n = np();
        return C(n, () => tp[e.name]), X(() => te(n, le("font-vt-220 font-medium leading-none whitespace-pre", e.class))), n
    })(),
...
const gp = "https://bmwryv10bd.execute-api.us-east-1.amazonaws.com",
    ...
    _p = async ({
        ...
        return await t.json()
    }, yp = z('<div class="flex flex-col space-y-120 w-full pt-72 pb-32"><div class="flex justify-between"><div class="flex space-x-24 items-center"></div><div class="flex space-x-24 items-center"></div></div><div class="flex flex-col space-y-48 items-center"><button class="inline-flex px-120 py-8 text-blue-light border text-shadow-terminal">'), bp = z('<input pattern="[0-9]*" inputmode="numeric">'), wp = {
        day: "00",
        month: "00",
        year: "00",
        hours: "00",
        minutes: "00",
        seconds: "00"
    }, Fn = "text-blue-light text-[20px]", Ap = e => {
        const [n, t] = Zt(wp), i = Wt(), o = {
            "typing-1": [0, 200],
...
var St = function(e) {
    ...
    Ro = /auto|scroll/,
    Wp = /^tb|vertical/,
    qp = /msie|trident/i.test(ln.navigator && ln.navigator.userAgent),
    Re = function(e) {
        return parseFloat(e || "0")
    },
    Nt = function(e, n, t) {
        return e === void 0 && (e = 0), n === void 0 && (n = 0), t === void 0 && (t = !1), new Zp((t ? n : e) || 0, (t ? e : n) || 0)
    },
    Vo = St({
    ...
    Yn = function() {
        ...
        return e.connect = function(n, t) {
            ...
            Fo(o.observationTargets, t) < 0 && (s && xt.push(o), o.observationTargets.push(new av(t, i && i.box)), Uo(1), ii.schedule())
