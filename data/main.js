...
const Wt = e => () => e,
    ...
    Rc = "/assets/bg-e180a5fa.png",
    Vc = "/assets/transition-video-177b7109.mp4",
    je = e => new URL(Object.assign({
        ...
        "../../../content/assets/scenes/scene/bg.png": Rc,
    ...
    Nd = e => {
        const n = is(),
            ...
            Y = async x => {
                try {
                    const A = c(),
                        $ = await (await Bl(() => import("./player-c5137be2.js"), [])).initPlayer({
                            refNode: x,
                            videoId: A.videoId,
