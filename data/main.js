...
const Wt = e => () => e,
    ...
    kc = "/assets/logbook-4-e1e4d6b8.jpg",
    $c = "/assets/logbook-5-b07340b1.jpg",
    Ic = "/assets/logbook-6-aad79ad3.jpg",
    Pc = "/assets/logbook-7-447b8550.jpg",
    Oc = "/assets/logbook-8-75782f09.jpg",
    Ec = "/assets/logbook-9-5c82ced1.jpg",
    Dc = "/assets/bg-5d806df7.png",
    Cc = "/assets/transition-video-c2ba428d.mp4",
    je = e => new URL(Object.assign({
        ...
        "../../../content/assets/logs/log/logbook-4.jpg": kc,
        "../../../content/assets/logs/log/logbook-5.jpg": $c,
        "../../../content/assets/logs/log/logbook-6.jpg": Ic,
        "../../../content/assets/logs/log/logbook-7.jpg": Pc,
        "../../../content/assets/logs/log/logbook-8.jpg": Oc,
...
var Uc = (e => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, {
    ...
    li;
try {
    li = Uc("solid-start/server").useRequest
} catch (e) {
...
const Zc = [{
    ...
    Kc = () => ft.isInstructionsModalViewed !== !0,
    Jc = () => {
        wn("isInstructionsModalViewed", !0)
    },
    Xc = () => ft.isDataUsageWarningDialogAccepted === !0,
    eu = () => {
...
function Au(e) {
    return function(n, t, r) {
        for (var i = function(a, d, v) {
                ...
                e ? n.add(d, yu(g)) : n.add(v, g)
            }, s = function() {
                var a = n.getPayload();
                if (e ? a.cx : a.co) return JSON.parse(e ? _u(a.cx) : a.co)
            }, l = function(a, d) {
                var v = a || s();
...
function Cs(e) {
    return Array.isArray(e) && e.length === 2 && Pu(e[0]) ? Array.isArray(e[1]) ? e[1].every(Ut) : Ut(e[1]) : !1
}
...
function Bu(e, n, t, r) {
    ...
    } else if (Cs(e) && Ou(e[0], r)) return eo(e[1], n, t, r);
    return []
}
...
function Vu(e) {
    ...
    function n(u, f, p) {
        ...
        function h(b, P, z) {
            b.withJsonProcessor(Au(d)), b.add("eid", hu.v4()), b.addDict(v);
            var Y = Ru(z);
...
function af(e, n) {
    for (var t = window.location.hostname, r = "_sp_root_domain_test_", i = r + new Date().getTime(), s = "_test_value_" + new Date().getTime(), l = t.split("."), c = l.length - 2; c >= 0; c--) {
        ...
        if (bt(i, s, 0, "/", u, e, n), bt(i) === s) {
            sr(i, u, e, n);
            for (var f = lf(r), p = 0; p < f.length; p++) sr(f[p], u, e, n);
            return u
        }
    }
    return t
...
var ff = "iglu:com.snowplowanalytics.snowplow/web_page/jsonschema/1-0-0",
    df = "iglu:com.snowplowanalytics.snowplow/browser_context/jsonschema/1-0-0",
    pf = "iglu:com.snowplowanalytics.snowplow/client_session/jsonschema/1-0-2",
    gf = "iglu:com.snowplowanalytics.snowplow/payload_data/jsonschema/1-0-4";

function vf(e, n, t, r, i, s, l, c, u, f, p, o, a, d, v, g, m) {
    var h = !1,
        y, w = [],
        b = !1;
...
function Ti(e, n, t) {
    var r;
    return e === "translate.googleusercontent.com" ? (t === "" && (t = n), n = (r = hf(n, "u")) !== null && r !== void 0 ? r : "", e = ro(n)) : (e === "cc.bingj.com" || e === "webcache.googleusercontent.com") && (n = document.links[0].href, e = ro(n)), [e, n, t]
}
var Hs = 0,
    wt = 1,
    mf = 2,
...
function yf(e, n, t, r) {
    ...
    var c = function(p, o) {
        ...
        f = [l[Hs], l[wt], c(l[mf], s), c(l[hn], r), c(l[ho], s), u(l[Fs]), l[lt], l[Lt], l[At], u(l[xt]), c(l[Ze], 0)];
    return f
}
    ...
    var l = [],
        c = function(p, o, a, d, v, g) {
            ...
            var oe = Vu({
                ...
                vr = !1;
            g.hasOwnProperty("discoverRootDomain") && g.discoverRootDomain && (Kt = af(kn, $n));
            var Bn = Lr(),
            ...
            function Oo(_) {
                var T = new Date().getTime(),
                    E = _.currentTarget;
                E != null && E.href && (E.href = sf(E.href, "_sp", Cn + "." + T))
            }
            ...
            function hr(_) {
                var T = Ot(_);
                if (ae == "localStorage") return rf(T);
                if (ae == "cookie" || ae == "cookieAndLocalStorage") return bt(T)
            }

            function Co() {
                vt(), $o = Zu((Kt || Je) + (fr || "/")).slice(0, 4)
            }
            ...
            function Vo() {
                if (!(Re && !Pt)) {
                    var _ = ae != "none" && !!hr("ses"),
                        T = Xt();
                    Cn = bf(T, Re), _ ? Ce = jr(T) : Ce = nn(T), Me = Br(T), ae != "none" && (mr(), Mr(T), _r(T))
                }
            }

            function Xt() {
                if (ae == "none") return _f();
                var _ = hr("id") || void 0;
                return yf(_, Cn, Ce, Me)
            }
            ...
            function Uo() {
                ...
                var _ = "_sp_tab_id",
                    T = wi(_);
                return T || (of(_, ot.v4()), T = wi(_)), T || null
            }
                ...
                return {
                    beforeTrack: function(E) {
                        ...
                        var ke = Lr(),
                            Et = ke.viewport,
                            en = ke.documentSize;
                        E.add("vp", Et), E.add("ds", en), E.add("vid", T(Me)), E.add("sid", T(Ce)), E.add("duid", _(Sf(ue))), E.add("uid", _(gt)), vt(), E.add("refr", ht(Xe || pt)), E.add("url", ht(Tn || De));
                        var tn = ki(ue, ae, Re);
            ...
            function Ea(_) {
                var T = _.context,
                    ...
                    nt = _.maxYOffset,
                    ke = document.title;
                ke !== It && (It = ke, Qt = void 0), oe.track(Uu({
                    pageUrl: ht(Tn || De),
                    pageTitle: xi(Qt || It),
                    referrer: ht(Xe || pt),
                    minXOffset: Ln(E),
...
function Of(e, n, t, r, i, s) {
    return ln.hasOwnProperty(e) ? null : (ln[e] = Pf(e, n, t, r, i, s), ln[e])
}
...
var $i = typeof window < "u" ? jf() : void 0;

function Vf(e, n, t) {
    if (t === void 0 && (t = {}), $i) return Of(e, e, "js-".concat(Hu), n, $i, t)
}
...
const Jf = Fe(),
    ...
    ed = () => {
        const e = [Zs, Ys],
            n = [...Xf.map(i => i.srcPng || i.srcJpg), null].reverse();
        n.length === 1 && e.push(Ws);
        const t = qs(n),
            r = t[t.length - 1];
        return r && e.push(...r.filter(i => !!i)), e
    },
    td = [Jf.bgSrc, Kf, _o, io, ...ed()],
    [Ks, yo] = W(0),
    [nd, rd] = W(!1),
    [od, id] = W(!1),
    sd = uo("standalone"),
    ad = async () => {
        yo(1);
        const e = td.map(n => Qs(n));
        await Promise.allSettled(e), rd(!0)
    }, Js = () => {
        sd || (window.location.href = "brawlstars-inbox://cctvloaded")
    };
pe(() => {
    nd() && od() && (Js(), yo(2))
});
...
const ld = () => {
    ...
    st = {
        init: ad,
        currentStatus: Ks,
        onVideoTransitionLoaded: ld,
        onVideoTransitionEnd: cd
    },
...
const Ii = e => typeof e == "boolean" ? "".concat(e) : e === 0 ? "0" : e,
    ...
    jd = e => {
        const n = is(),
            ...
            Y = async x => {
                try {
                    const A = u(),
                        $ = await (await jl(() => import("./player-4a89766d.js"), [])).initPlayer({
                            refNode: x,
                            videoId: A.videoId,
    ...
    Nd = () => Ft().find(e => e.isCenter()),
    zd = () => {
        const e = Ft().filter(n => n.isLive() && n.status() === "playing");
        return e.length > 0 ? e.every(n => n.isAtEdge()) : !1
    },
    Ud = xe(() => qe.length > 0 && qe.every(e => e.status() !== "initializing")),
    Hd = xe(() => Ft().length > 0 && Ft().every(e => e.status() === "ended")),
    Fd = e => {
    ...
    Zd = async e => {
        ...
        try {
            e === "play" && await Promise.all(Ft().map(Zd)), await Promise.all(Ft().map(n => n.Player.dispatch(e)))
        } catch (n) {
            console.warn(n)
        }
    }, Wd = async e => {
        try {
            Vd(e), !!e.archivePlaylist ? await Promise.all(qe.map(t => t.switchFeed(e.archivePlaylist))) : await Promise.all(qe.map((t, r) => {
        ...
        Supervisor: {
            ...
            resetScreensPosition: Gd,
            controlsVisible: Bd,
            setControlsVisible: Ld,
            switchFeed: Wd,
            allAtEdge: zd,
            allLoaded: Ud,
            allEnded: Hd,
    ...
    }, qd = V('<div role="button" class="absolute top-0 left-0 wh-full">'), Qd = V('<div class="absolute bottom-0 left-0 right-0 h-[228px] px-[158px] flex space-x-68 items-center"><button></button><button></button><button></button><button></button><button>'), rn = ["w-[330px] h-[100px] flex-center bg-player-control-btn text-green rounded-sm", "shadow-player-controls-btn active:shadow-player-controls-btn-pressed", "[&>span]:w-72 [&>span]:drop-shadow-terminal"], Kd = () => {
        const e = ct([dd, fd], {
            sprite: {
...
const Jd = (e, n) => {
    ...
    Xd = e => {
        const [n, t] = Yt({
            ...
            !Ei(f) || !n.isEnabled || (f.preventDefault(), t(p => {
                ...
                return {
                    scale: Math.min(Math.max(1, Jd(o, 10)), 4),
                    delta: {
                        x: a,
                        y: d
                    }
    ...
    ep = "/assets/seek-video-dab3075d.mp4",
    tp = V('<video playsinline muted loop class="absolute top-0 left-0 wh-full object-cover">'),
    np = V('<div class="absolute top-0 left-0 bg-black z-10 wh-full">'),
    Ci = V("<span>"),
    rp = V('<div class="absolute top-72 left-72 flex items-center space-x-8 text-white">'),
    op = {
    ...
    sp = e => {
        ...
        pe(() => {
            ...
            if (u === "syncing") return;
            const p = e.screen.isAtEdge() && u === "playing" ? "live" : op[u];
            r(p);
            let o;
        ...
        return pe(() => {
            ...
            const u = tp(),
                f = n;
            return typeof f == "function" ? $e(f, u) : n = u, ie(u, "src", ep), K(() => (c() ? "visible" : "hidden") != null ? u.style.setProperty("visibility", c() ? "visible" : "hidden") : u.style.removeProperty("visibility")), u
        })(), S(as, {
            get children() {
                return [S(Bt, {
                    get when() {
    ...
    ap = V('<button class="absolute top-0 left-0 isolate"><div>'),
    lp = {
        c: {
            coordinates: {
                x: 621,
    ...
    cp = e => {
        ...
        return pe(() => {
            ...
            const f = r;
            return typeof f == "function" ? $e(f, u) : r = u, D(c, S(sp, {
                get screen() {
                    return e.screen
                }
            }), null), K(p => {
...
const up = () => {
    ...
    fp = V('<img class="absolute top-0 left-0 wh-full pointer-events-none">'),
    ...
    gp = V('<button class="absolute origin-top-left">'),
    vp = [{
        appName: "terminal",
        position: {
            x: 319,
...
Ie(["click"]);
const mp = "/assets/answering-machine-button-glow-58ea4526.svg",
    _p = V('<img class="absolute origin-bottom-left">'),
    yp = {
        "phone-button-light": {
            position: {
                x: 1914,
    ...
    xp = V('<div class="absolute origin-top-left bg-black"><img class="absolute top-0 left-0 wh-full object-cover"><img>'),
    Sp = "absolute top-0 left-0 wh-full object-cover",
    Tp = () => (() => {
        const e = xp(),
            n = e.firstChild,
            t = n.nextSibling;
        return e.style.setProperty("width", "150px"), e.style.setProperty("height", "85px"), e.style.setProperty("transform", "translate(403px, 924px) rotateZ(-4deg)"), ie(n, "src", wp), ie(t, "src", Ap), K(() => te(t, ce(Sp, {
            hidden: !We.archive.hasNew()
        }))), e
    })(),
    kp = V('<div class="absolute top-0 left-0 wh-full isolate">'),
    $p = e => {
        ...
        return (() => {
            ...
            }), null), D(p, S(Tp, {}), null), D(p, S(pp, {}), null), D(p, S(bp, {}), null), D(p, S(hp, {
                onItemSelected: f
            }), null), D(p, S(Le, {
                get when() {
    ...
    Ip = V('<div class="absolute top-0 left-0 wh-full z-modal">'),
    ur = e => S(Le, {
        get when() {
            return e.isOpen
        },
    ...
    Pp = "/assets/logbook-36af03c8.mp3",
    Op = "/assets/logbook-dccdaf17.ogg",
    Ep = V('<div><img><img><img class="absolute left-1/2 w-1/2 h-full"><img><img><div class="absolute top-0 left-0 wh-full flex"><button class="flex-1"></button><button class="flex-1"></button></div><button class="absolute top-20 left-20 w-100 h-100 flex-center">'),
...
const Mp = e => S(ur, {
    ...
    jp = "/assets/terminal-2aa26d8b.mp3",
    Bp = "/assets/terminal-ca9f8876.ogg",
    ra = Ua(),
    Lp = e => {
...
const Rp = "\n      @@@@@@@@@@@@@@@@@@@@@@@@@@@@\n    @@                         @@@\n @@                          @@@@@\n@                         @@@@@@@@\n@                         @@@@@@@@\n@  @@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @     @@@@@@@@@@    @@ @@@@@@@@\n@  @     @@      @@    @@ @@@@@@@@\n@  @     @@      @@    @@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@\n@                         @@@@@@@@\n@  @@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @     @@@@@@@@@@    @@ @@@@@@@@\n@  @     @@      @@    @@ @@@@@@@@\n@  @     @@      @@    @@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @                   @@ @@@@@@@@\n@  @@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@ \n@                         @@@@@\n@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n",
    ...
    St = e => (() => {
        const n = Fp();
        return D(n, () => Hp[e.name]), K(() => te(n, ce("font-vt-220 font-medium leading-none whitespace-pre", e.class))), n
    })(),
    Gp = V("<span>Security Archives"),
    Zp = V("<span>Time Coder"),
    Yp = V('<div class="wh-full flex justify-center space-x-368 items-end pb-144"><div class="flex flex-col items-center space-y-56" role="button"></div><div class="flex flex-col items-center space-y-56 text-shadow-terminal" role="button">'),
...
const qp = V('<div class="absolute top-0 left-0 wh-full flex flex-col items-center pt-72 bg-terminal"><img class="block w-[732px] mb-32 text-blue-light drop-shadow-terminal transform-gpu" width="873" height="621"><div class="flex space-x-32 text-blue-light"><div class="bg-blue-light shadow-terminal"></div><div class="w-24 h-full bg-blue-light shadow-terminal">'),
    ...
    Jp = (e = {}) => {
        const [n, t] = W(ji(e.timezone)), r = () => {
            ...
            t(s)
        }, i = setInterval(() => r(), Kp * 1e3);
        return Ae(() => clearInterval(i)), n
    },
    Bi = V("<span>"),
    Xp = V("<span>Starr Park Security System"),
    eg = () => {
        const e = Jp({
            timezone: hs
        });
    ...
    tg = V('<div><div class="flex w-full"><button><span>&lt;-</span></button><div class="flex items-center flex-1 h-full px-32 bg-blue-light text-blue-light shadow-terminal"></div></div><div class="flex-1 min-h-0 px-100">'),
    ng = "w-100 h-100 flex-center font-vt-220 font-medium leading-none text-shadow-terminal",
    Vr = e => {
        const n = qt(),
            t = () => {
                var i;
        ...
        return (() => {
            ...
            return s.$$click = () => t(), D(l, S(se, {
                ...
                const f = ce("flex flex-col flex-1 pt-64 px-44"),
                    p = ce(ng, "text-purple text-[80px] tracking-[-10px]");
...
Ie(["click"]);
const rg = "/assets/terminal-typing-8b10cd31.mp3",
    og = "/assets/terminal-typing-20a23c49.ogg";
...
const ig = "https://bmwryv10bd.execute-api.us-east-1.amazonaws.com",
    ia = {
        base: "".concat(ig),
    ...
    sg = async ({
        ...
        return await t.json()
    }, ag = V('<div class="flex flex-col space-y-120 w-full pt-72 pb-32"><div class="flex justify-between"><div class="flex space-x-24 items-center"></div><div class="flex space-x-24 items-center"></div></div><div class="flex flex-col space-y-48 items-center"><button class="inline-flex px-120 py-8 text-blue-light border text-shadow-terminal">'), lg = V('<input pattern="[0-9]*" inputmode="numeric">'), cg = {
        day: "00",
        month: "00",
        year: "00",
        hours: "00",
        minutes: "00",
        seconds: "00"
    }, Gn = "text-blue-light text-[20px]", ug = e => {
        const [n, t] = Yt(cg), r = qt(), i = {
            "typing-1": [0, 200],
...
Ie(["click"]);
const gg = V('<span class="text-black">Access Security System'),
    vg = V('<div class="wh-full flex flex-col items-center space-y-76 pt-76 "><img class="w-[872px] drop-shadow-terminal text-blue-light transform-gpu" width="873" height="621">'),
    hg = e => {
...
Ie(["click"]);
const bg = V('<div class="realtive wh-full flex flex-col bg-terminal">'),
    wg = e => {
    ...
    xg = "/assets/cctv-room-e0e04e21.ogg";
...
const kg = e => {
    ...
    $g = V("<div><video muted playsinline>"),
    Ig = 7.1,
    Pg = 7.7,
    Og = e => {
        let n;
        ...
        return Gt(async () => {
            ...
            const l = () => {
                !n || n.currentTime < Ig || (e.onEnded(), n.removeEventListener("timeupdate", l))
            };
            n.addEventListener("timeupdate", l);
            const c = () => {
                n && (n.currentTime = Pg, n.play())
            };
...
var $t = function(e) {
    ...
    zi = /auto|scroll/,
    Bg = /^tb|vertical/,
    Lg = /msie|trident/i.test(un.navigator && un.navigator.userAgent),
    Ve = function(e) {
        return parseFloat(e || "0")
    },
    Vt = function(e, n, t) {
        return e === void 0 && (e = 0), n === void 0 && (n = 0), t === void 0 && (t = !1), new Mg((t ? n : e) || 0, (t ? e : n) || 0)
    },
    Ui = $t({
    ...
    ca = function(e, n) {
        ...
        var t = getComputedStyle(e),
            ...
            i = !Lg && t.boxSizing === "border-box",
            s = Bg.test(t.writingMode || ""),
    ...
    Yg = function() {
        ...
        return e.prototype.run = function(n) {
            ...
            var n = this,
                t = function() {
                    return n.observer && n.observer.observe(document.body, Zg)
                };
    ...
    Wg = function(e) {
        return !bo(e) && !jg(e) && getComputedStyle(e).display === "inline"
    },
    qg = function() {
        function e(n, t) {
        ...
        return e.prototype.isActive = function() {
            ...
            return Wg(this.target) && (this.lastReportedSize = n), this.lastReportedSize.inlineSize !== n.inlineSize || this.lastReportedSize.blockSize !== n.blockSize
        }, e
    }(),
    Qg = function() {
        function e(n, t) {
...
const Jg = () => {
        "ResizeObserver" in window || (window.ResizeObserver = Kg)
    },
    Xg = {
        setup: Jg
    },
    ev = V('<div class="wh-full flex-center bg-black/80"><div class="w-[1100px] flex flex-col space-y-32"><div class="px-20 py-12 bg-blue-light text-black"></div><div class="bg-black p-20"><div class="flex-center flex-col space-y-32 p-24 border border-purple"><div class="flex space-x-128"><button><span>No</span></button><button><span>Yes'),
...
Ie(["click"]);
const rv = V('<div class="wh-full flex-center bg-black/80"><div class="w-[1100px] flex flex-col space-y-32"><div class="px-20 py-12 bg-blue-light text-black"></div><div class="bg-black p-20"><div class="flex-center flex-col space-y-32 p-24 border border-purple"><div class="flex space-x-128"><button><span>Exit</span></button><button><span>Continue'),
...
Ie(["click"]);
const sv = V('<button class="absolute top-20 left-20 w-100 h-100 flex-center">'),
    av = V('<button class="absolute top-20 right-20 w-100 h-100 flex-center text-purple">'),
    lv = V('<div class="wh-full"><div class="portrait:hidden absolute origin-top-left overflow-hidden"></div><div class="landscape:hidden portrait:flex wh-full flex-center"><div class="font-medium whitespace-nowrap">Portrait mode is not supported.'),
    cv = V('<div class="absolute bottom-0 left-0 w-256">');
Xg.setup();
const Hr = {
        width: 2250,
        height: 1170
...
Ie(["click"]);
cl(() => S(uv, {}), document.getElementById("root"));
export {
    bn as a, Ge as c, dv as g
};